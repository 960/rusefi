...
BOARDSRC_CPP = $(BOARDS_DIR)/ME7_Assembled_2/board_configuration.cpp
...
ifeq ($(PROJECT_CPU),ARCH_STM32F4)
  ...
  BOARDINC = $(BOARDS_DIR)/microrusefi		# For board.h
...
DDEFS += $(MCU_DEFS) -DEFI_USE_OSC=TRUE -DEFI_FATAL_ERROR_PIN=GPIOF_0 -DFIRMWARE_ID=\"microRusEfi\" $(DEFAULT_ENGINE_TYPE)
